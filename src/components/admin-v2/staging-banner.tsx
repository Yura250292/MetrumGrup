...
export function StagingBanner() {
  ...
  return (
    <div className="sticky top-0 z-40 w-full overflow-hidden border-b border-amber-300 bg-amber-400 text-amber-950 dark:border-amber-700 dark:bg-amber-500 dark:text-amber-950">

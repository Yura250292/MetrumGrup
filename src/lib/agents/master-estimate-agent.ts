...
- НЕ дублюй позиції з інших секцій (див. "Вже згенеровані секції" у промті)`;
  ...
  private buildSectionPrompt(
    ...
    if (context.documents?.drawingsVisual) {
      ...
      prompt += `⚠️ Для quantity позицій бери розміри/площі/кількості САМЕ з обміру вище.\n`;
      prompt += `Якщо позиції цієї секції немає в обмірі — оцінюй за площею проєкту, але не ігноруй обмір.\n\n`;
    }

...
⭐ ДЖЕРЕЛО ЦІН: Збірник 15 «Оздоблювальні роботи» — офіційні кошторисні норми України (748 норм).
Система автоматично знаходить відповідні норми зі Збірника 15 по опису роботи.
...
- Коли знаєш код норми — додай його в notes (напр., "Zbirnyk 15-62-1")

СПЕЦІАЛІЗАЦІЯ:
- Облицювальні роботи (плитка, граніт, мармур) — Збірник 15, розділ 1
- Штукатурні та декоративні роботи — Збірник 15, розділ 2
- Ліпні роботи — Збірник 15, розділ 3
- Малярні роботи (фарбування, грунтування) — Збірник 15, розділ 4
- Склярські роботи — Збірник 15, розділ 5
- Шпалерні роботи — Збірник 15, розділ 6
...
6. laborCost має бути розрахований за нормами Збірника 15 (люд.-год × 250 ₴/год × 1.25 накладних)

...
export interface WizardData {
  ...
  // Перемикач режиму кошторису:
  //  true  — тільки внутрішні / оздоблювальні роботи (об'єкт уже збудований):
  //          без земляних робіт, фундаменту, несучих конструкцій, покрівлі, фасаду.
  //  false — повний цикл (будівництво з нуля).
  // Якщо не задано — режим визначається за objectType/workScope.

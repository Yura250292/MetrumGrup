...
export type ProjectNotificationType =
  ...
  | "CHANGE_ORDER_PM_APPROVED"
  | "CHANGE_ORDER_ADMIN_APPROVED"
  ...
  | "RFI_COMMENT"
  | "RFI_CLOSED"
  | "COUNTERPARTY_LICENSE_EXPIRING_30"
  | "COUNTERPARTY_LICENSE_EXPIRING_7"
  | "COUNTERPARTY_LICENSE_EXPIRED"
  | "COUNTERPARTY_TAX_STATUS_CHANGED"
  | "ESTIMATE_PROPOSAL_VIEWED"
  | "ESTIMATE_PROPOSAL_CLIENT_ACTION"
  | "ESTIMATE_PROPOSAL_FULLY_APPROVED"
  | "ESTIMATE_PROPOSAL_REJECTED"
  | "ESTIMATE_PROPOSAL_EXPIRING_24H"
  | "ESTIMATE_PROPOSAL_EXPIRED";

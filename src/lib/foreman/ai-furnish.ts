...
ОБОВ'ЯЗКОВО — БАГАТО ПРЕДМЕТІВ для повноцінного інтер'єру.
Цільові мінімуми (намагайся ДАТИ БІЛЬШЕ):
- kitchen: 10-14 (холодильник, мийка, плита, ДУХОВКА, посудомийка, мікрохвильовка/витяжка хоча б суб'єктом, мін. 2 секції шафи, обідній стіл з 2-4 стільцями, рослина, килимок)
- livingroom: 12-16 (диван, 2 крісла, журн.стіл, тв, тв-стійка/тумба, 2-3 рослини, килим, книжкова полиця, бічна тумба, торшер-суб'єкт)
- bedroom: 9-12 (двоспальне ліжко, 2 тумби, шафа-купе, туал.столик/комод, стілець, крісло, килим, рослина, дзеркало-суб'єкт)
- bathroom: 6-8 (ванна або душ, унітаз, раковина, пралка, шафа/полиця для рушників, дзеркало-суб'єкт, ще одна полиця)
- office: 7-9 (стіл, крісло, 2 полиці, тумба, шафа, крісло-вільне, рослина)
- diningroom: 8-10 (стіл, 4-6 стільців, сервант, рослина, килим)
- hallway: 3-5 (шафа для одягу, полиця взуття, тумба з дзеркалом, рослина, килимок)
- corridor: 0-1 (тільки якщо ширина >1.5м, можна додати картину-суб'єкт чи рослину)

ВАЖЛИВО: ТИ ЗОБОВ'ЯЗАНИЙ дати ЯКОМОГА БІЛЬШЕ предметів у межах площі. Порожні
стіни і кути — лише ВИНЯТОК. Кімнати мають виглядати "наповненими" і
функціональними, як на фото з ArchDaily/Pinterest, а НЕ як склад на 3 предмети.
Якщо предмет не вміщається повністю — ЗМЕНШИ розмір (мінімум 0.3×0.3) і додай
все одно. Краще 14 щільних предметів, ніж 5 розкиданих.

...
- kitchen: 6-9 (холодильник, мийка, плита, посудомийка, 1-2 секції кух.шафи, обідній стіл зі стільцями, рослина)
- livingroom: 7-10 (диван, 1-2 крісла, журн.стіл, тв, тв-стійка, килим, рослина, полиця)
- bedroom: 6-8 (двоспальне ліжко, 2 тумби, шафа-купе, комод або туал.столик, килим, рослина)
- bathroom: 4-6 (ванна або душ, унітаз, раковина, пралка, полиця)
- office: 5-7 (стіл, крісло, 1-2 полиці, тумба, рослина)
- diningroom: 5-7 (стіл, 4-6 стільців, сервант, рослина)
- hallway: 2-4 (шафа для одягу, полиця взуття, тумба з дзеркалом)
- corridor: 0-1 (лише якщо ширина >1.5м — рослина)

🚫 БЕЗ НАКЛАДАНЬ — НАЙВАЖЛИВІШЕ ПРАВИЛО:
- Кожен предмет — окремий прямокутник. Предмети НЕ перетинаються один з одним.
- Виняток: стільці можуть стояти впритул до столу чи трохи під ним; килим (rug)
  лежить ПІД меблями — його накладання дозволене.

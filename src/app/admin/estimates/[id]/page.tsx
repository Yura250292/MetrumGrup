            ...
            <div key={section.id} className="mb-4">
              <EditableSectionTable
                ...
                items={section.items.map((item) => ({
                  ...
                  unitPriceCustomer: (item as any).unitPriceCustomer ?? null,
                  foremanId: (item as any).foremanId ?? null,
                  foreman: (item as any).foreman ?? null,
                  executorText: (item as any).executorText ?? null,

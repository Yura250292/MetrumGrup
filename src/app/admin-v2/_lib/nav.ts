...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin-v2/counterparties?role=SUPPLIER", label: "Постачальники", icon: Truck, pillBadge: { text: "NEW", color: "accent" } },
      { href: "/admin-v2/financing/supplier-payments", label: "Платежі постачальникам", icon: Wallet, pillBadge: { text: "NEW", color: "accent" } },
...
export const BREADCRUMB_MAP: Record<string, string> = {
  ...
  "/admin-v2/financing/supplier-payments": "Платежі постачальникам",

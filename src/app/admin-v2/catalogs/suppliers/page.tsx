...
import { SuppliersCatalog } from "./_components/suppliers-catalog";

export const dynamic = "force-dynamic";

export default async function SuppliersCatalogPage() {
    ...
    <div className="flex flex-col gap-4">
      ...
      <header className="flex items-center gap-2">
        ...
        <span className="text-[11px]" style={{ color: T.textMuted }}>
          — матеріали і ціни. Запис унікальний на (постачальник, матеріал) —
          дублі не плодяться.
        </span>
      </header>

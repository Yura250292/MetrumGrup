...
export const WIDGET_REGISTRY: Record<WidgetType, WidgetDefinition> = {
  ...
  // dashboard-v2.pen widgets — server-rendered via slots in /admin-v2/page.tsx.
  "cashflow-chart": {
    type: "cashflow-chart",
    label: "Грошовий потік · графік",
    description: "Area-чарт надходжень і витрат за останні 30 днів",
    icon: ArrowDownUp,
    defaultSize: "4x2",
    sizes: ["2x2", "3x1", "4x1", "4x2"],
    serverRendered: true,
  ...
  "project-margin": {
    type: "project-margin",
    label: "Маржа по проєктах",
    description: "Топ-6 проєктів за бюджетом з фактичною маржею",
    icon: Percent,
    defaultSize: "2x2",
    sizes: ["2x1", "2x2", "3x1"],
    serverRendered: true,
  ...
  "today-live": {
    type: "today-live",
    label: "Сьогодні · LIVE",
    description: "Робітники, обʼєкти, погода й активні роботи зараз",
    icon: Sun,
    defaultSize: "2x2",
    sizes: ["2x1", "2x2"],
    serverRendered: true,
  ...
  "activity-timeline": {
    ...
    label: "Активність · timeline",
    description: "Multi-source стрічка: foreman, етапи, фінанси, ДУ",
    icon: Activity,
    defaultSize: "4x2",
    sizes: ["2x2", "3x1", "4x2"],
    serverRendered: true,
  ...
  "margin-kpi-tile": {
    type: "margin-kpi-tile",
    label: "Маржа · KPI",
    description: "Маржа план/факт vs ціль компанії 22%",
    icon: Percent,
    defaultSize: "1x1",
    sizes: ["1x1", "2x1"],
    serverRendered: true,
  ...
  "live-workers-tile": {
    type: "live-workers-tile",
    label: "Робітники · LIVE",
    description: "Скільки робітників на скількох обʼєктах сьогодні",
    icon: HardHat,
    defaultSize: "1x1",
    sizes: ["1x1", "2x1"],
    serverRendered: true,
  ...
  "deadline-watchlist": {
    type: "deadline-watchlist",
    label: "Топ проєктів + дедлайн",
    description: "Watchlist з колонкою дедлайну та badge ризику",
    icon: CalendarClock,
    defaultSize: "4x2",
    sizes: ["4x1", "4x2"],
    serverRendered: true,

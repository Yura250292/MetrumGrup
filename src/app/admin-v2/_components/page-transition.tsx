...
export function PageTransition({ children }: { children: ReactNode }) {
  ...
  // exit лишаємо opacity=1 — якщо AnimatePresence не доведе exit до кінця
  // (наприклад швидкі переходи або обірване rendering у App Router), сторінка
  // не "застрягне" напівпрозорою. Анімація відчутна лише на enter.
  const variants = reduce
    ...
    : isMobile
      ? {
          ...
          exit: { opacity: 1, x: -16, rotateY: -7, scale: 0.98 },
        }
      : {

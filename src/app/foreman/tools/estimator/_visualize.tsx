    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-3 flex gap-2.5">
        ...
        <p className="text-[11px] text-zinc-400 leading-relaxed">
          Це 2D-візуалізація меблювання — AI бачить розміри і прорізи й
          пропонує реалістичну розстановку. Photoreal 3D-рендер
          (план→реалістика) буде в наступному кроці; він прив'язується до
          конкретного проєкту у системі.
        </p>
      </div>
    </div>
  );

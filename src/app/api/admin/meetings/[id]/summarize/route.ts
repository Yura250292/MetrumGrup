...
- МОВА: транскрипт може бути двомовним (українська/російська) або повністю російською — це нормально, наша компанія працює з мережею АТБ і частина контактів-партнерів спілкується російською. Підсумок (summary, keyPoints, decisions, тощо) — завжди українською. АЛЕ імена/прізвища/по-батькові — ЗБЕРІГАЙ В ОРИГІНАЛЬНІЙ МОВІ І НАПИСАННІ як у транскрипті. «Любовь Николаевна» лишається «Любовь Николаевна», НЕ перекладай у «Любов Миколаївна» і тим паче не «адаптуй» до фонетики. Те саме — назви російськомовних компаній, посади, які звучали російською. Імʼя — це ідентифікатор людини, переклад або адаптація = втрата контакту.
- Зберігай імена учасників так, як їх вимовляли (Сергій, Олег, Андрій, Анна, Любовь Николаевна тощо). По-батькові — якщо звучало.
